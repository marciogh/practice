...
public class ReoderLogs {
    ...
    public String[] reorderLogFiles(String[] logs) {
        ...
        for (int i = 0; i < logs.length; i ++) {
            ...
            if (isContentNumeric(content)) {
                List<String> contents = digiLogs.getOrDefault(identifier, new ArrayList<String>());
                contents.add(content);
                digiLogs.put(identifier, contents);
            } else {
                List<String> identifiers = letterLogs.getOrDefault(content, new ArrayList<String>());
    ...
    public void testComparator() {
        ...
        String[] logs = new String[]{"abc dad", "cde cda", "kkk 123", "abc asd"};
        Arrays.sort(logs, c);
        assertArrayEquals(
            new String[]{"abc asd", "abc dad", "cde cda", "kkk 123"},
            logs
        );
    }
